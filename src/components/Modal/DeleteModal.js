...
function ProductEditModal({ toggle, modalVisible, CancelAction, item, updateAction, heading, description }) {
    return (
        <Modal
            transparent={true}
            ...
            <View style={styles.container}>
                ...
                <View style={styles.modalContainer}>
                    ...
                    <View style={styles.modalHeader}>
                        <Text style={styles.title}>{heading ? heading : 'Confirm Delete'} </Text>
                    </View>
                    ...
                    <View style={styles.modalBody}>
                        <View style={{ paddingHorizontal: 10 }}>
                            <Text>{description ? description : AlertMessage.DELETE_MODAL_DESCRIPTION}</Text>
                        </View>
                        {item && (
                            <ProductCard
